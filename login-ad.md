...
* **TrackAbout Web » Customer Portal Users Page**: A new Customer Portal Users page is now available for internal users with the appropriate role who manage multiple customers with Customer Portal access. This page provides a single, consolidated view of all Customer Portal users across customers, eliminating the need to open individual customer records to find or manage users. From this page, CSRs can both review and edit Customer Portal users directly. **Note**: To view this page, you must have the **View Customer Users** permission assigned to your role in User Access Control.
...
* **TrackAbout Web » Black Hole Finds Report**: Improvements were made to how the Black Hole Finds report was sorting and displaying results.
